...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                <div class="col">
                    <form action="{{ route('adm.updateheader',$header->id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="content" value="<?= old('pesan') ?>" name="pesan" id="exampleFormControlTextarea1" rows="5">{{ $header->content }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label style="mb-3" for="exampleFormControlFile1">Input Gambar</label>
                            <input type="hidden" name="gambar" value="{{ $header->img }}">
