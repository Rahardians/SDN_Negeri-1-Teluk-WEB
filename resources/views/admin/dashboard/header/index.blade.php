...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <a href="{{ route('adm.addheader') }}" class="btn btn-primary">Tambah</a>
            <br>
            <br>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="" class="btn btn-primary btn-sm">Detail</a>
                            <a href="{{ route('adm.editheader',$row->id) }}" class=" btn btn-info btn-sm">Update</a>
                            <a href="{{ route('adm.deleteheader',$row->id) }}" class=" btn btn-danger btn-sm">Delete</a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
