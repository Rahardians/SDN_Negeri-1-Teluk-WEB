...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3>Fasilitas Kantin</h3>
        </div>
        <div class="card-body">
        <a href="{{ route('adm.addkantin') }}" class="btn btn-primary">Tambah</a>
            <br>
            <br>
            <table class="table-hover dataTable" style="width: 100%" cellpadding="4" id="basic-datatables">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('adm.editkantin',$row->id) }}" class=" btn btn-info btn-sm">Update</a>
                            <a href="{{ route('adm.deletekantin',$row->id) }}" class=" btn btn-danger btn-sm">Delete</a></td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
